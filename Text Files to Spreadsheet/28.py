#Reads the content of text file(s) and inserts content into new spreasheet.
...
if len(sys.argv) > 1:
    ...
    #Use the first fil;ename given in saving new filename.
    p = files[0][:-4] + '_text_files.xlsx'

    wb.save(p)

    print('Text files successfully saved to spreasheet as ' + p)
