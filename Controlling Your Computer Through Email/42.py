#python3! - Write a program that checks an email account every 15 minutes for any instructions
...
def check_for_torrents(imap_address, email_address, password, verified_creds):
    ...
    Args:
        ...
        verified_creds(dict): dict containing verified email and password
    '''
...
def send_reminder(accountSID, authToken, myTwilioNumber, myCellPhone, message):
    ...
    create(body='Rain Alert! Grab an umbrella.',\
...
if __name__ == "__main__":
    ...
    links = check_for_torrents('imap.gmail.com', email, password,\
                               {'email': 'verified_email@x.com', 'password': 'vpass'})
