# python3! - Write a program that will automatically send out a notification message to a select group of people on your friend list

import time
import pyautogui

def auto_message(name, message):
    '''Searches for friend on Google Talk(Hangouts) and messages them.'''
    print("Make sure the Google Hangouts 'Conversations' page is visible and"
